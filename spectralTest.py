"""
 --------------------------------------------------------------------------------------
    Original pseudo code from the book: " The Art of Computer Programming"
    Authors: Laura Pareja, Marina Amorim, and Scott Simmons
    Date of Creation: 02/21/22
...
def main():
    # Create a list of a's and m's and perform the spectral test on each pair. 
    # Change the values here to look at different cases.
